...
func (s *Server) RpcReaddir(in *ReaddirRequest, reply *ReaddirReply) (err error) {
	...
	dirEnts, err := mountHandle.ReaddirOne(inode.InodeRootUserID, inode.InodeGroupID(0), nil, inode.InodeNumber(in.InodeNumber), inode.InodeDirLocation(in.PrevDirLocation))
...
func (s *Server) RpcReaddirPlus(in *ReaddirPlusRequest, reply *ReaddirPlusReply) (err error) {
	...
	dirEnts, statEnts, err := mountHandle.ReaddirOnePlus(inode.InodeRootUserID, inode.InodeGroupID(0), nil, inode.InodeNumber(in.InodeNumber), inode.InodeDirLocation(in.PrevDirLocation))
